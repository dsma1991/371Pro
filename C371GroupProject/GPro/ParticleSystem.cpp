 ...
 *                                                    *
 * ParticleSystem.cpp                                         *
 *    This is the source file for ParticleSystem.h. It        *
 ...
 */
void ParticleSystem::createParticles(void)
{
 ...
 */
void ParticleSystem::turnToSmoke(Particle *p)
{
   p->lifespan = (((rand()%125+1)/10.0f)+5);
   p->age = 0.0f;
   p->scale = 0.25f;
...
void ParticleSystem::setParticleSystemType(int type)
{
   systemType = type;
}

int ParticleSystem::getNumOfParticles(void)
{
   return MAX_PARTICLES;
}

float ParticleSystem::getXPos(int i)
{
   return particles[i].position[X];
}

float ParticleSystem::getYPos(int i)
{
   return particles[i].position[Y];
}
float ParticleSystem::getZPos(int i)
{
   return particles[i].position[Z];
}

float ParticleSystem::getR(int i)
{
   return particles[i].color[X];
}

float ParticleSystem::getG(int i)
{
   return particles[i].color[Y];
}
float ParticleSystem::getB(int i)
{
   return particles[i].color[Z];
}

float ParticleSystem::getScale(int i)
{
   return particles[i].scale;
}

float ParticleSystem::getDirection(int i)
{
...
void ParticleSystem::modifyParticleSystemPull(float x, float y, float z)
{
   systemPull[X] += x;
   systemPull[Y] += y;
   systemPull[Z] += z;
