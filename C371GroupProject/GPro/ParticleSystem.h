...
public:
   ...
   void setParticleSystemType(int systemType); //sets the particle system type
   ...
   void modifyParticleSystemPull(float x, float y, float z); //used to modify x,y,z pull magnitudes
